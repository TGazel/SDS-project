...
Below is an example using "timeshighered". Repeat for 36 newspaper accounts.
```{r message=FALSE, warning=FALSE}
library(rtweet)
timeshighered <- get_followers(
  "timeshighered",
  n = Inf,
...
save(timeshighered, file="timeshighered.RData")
```
...
```{r warning=FALSE}
dir.create("data/CleanData", showWarnings = F)

# Financial Times

load("data/Follower lists/FinancialTimes.RData")
load("data/Follower lists/FT.RData")
...
save(FTmerged, file="data/CleanData/FinancialTimes.RData")

# Guardian

load("data/Follower lists/guardian.RData")
load("data/Follower lists/guardiannews.RData")
...
save(Gmerged, file="data/CleanData/guardian.RData")

# Daily Mail

load("data/Follower lists/MailOnline.RData")
load("data/Follower lists/DailyMailUK.RData")
...
save(Mailmerged, file="data/CleanData/MailOnline.RData")

# The Sun

load("data/Follower lists/TheSun.RData")
load("data/Follower lists/Fabulousmag.RData")
...
load("data/Follower lists/EveningStandard.RData")   # 131560
load("data/Follower lists/standardnews.RData")      # 639703 - most followed!
load("data/Follower lists/standardsport.RData")     #  42006
load("data/Follower lists/standardcity.RData")      #   7791
...
save(ESmerged, file="data/CleanData/standardnews.RData")

# Metro

load("data/Follower lists/MetroUK.RData")
load("data/Follower lists/MetroScotland.RData")
...
load("data/Follower lists/dailystar.RData")
load("data/Follower lists/DStarPics.RData")
...
To run this part, please make sure that directory: "data/CleanData" is available. Or you can directly start from chunk: "load data".

Construct dataframe for directed graph.

```{r directed data, warning=FALSE}
route = "data/CleanData"
